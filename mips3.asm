...
create_content_hash:
   ...
   syscall
	...
	# -$s0: pointer to the first elemenet of the hashtable contents.
	...
	filling_hash_table:
		...
		move $a0 $s0		# cargamos la direccion sobre la cual vamos a crear la lista.
